...
public class DomainIllegalStateException extends Exception {
  ...
  /**
   * Constructs a new domainexception with {@code null} as its detail message.  The cause is not
   * initialized, and may subsequently be initialized by a call to {@link #initCause}.
   */
  public DomainIllegalStateException() {
  }

  /**
   * Constructs a new domainexception with the specified detail message. The cause is not
   * initialized, and may subsequently be initialized by a call to {@link #initCause}.
   *
  ...
  /**
   * Constructs a new domainexception with the specified detail message and cause.  <p>Note that the
   ...
   * @since 1.4
   */
  public DomainIllegalStateException(String message, Throwable cause) {
    super(message, cause);
  }

  /**
   * Constructs a new domainexception with the specified cause and a detail message of {@code
